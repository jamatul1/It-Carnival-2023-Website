export function startCanvas(canvas, text = "It Carnival 2023") {
  ...
  class Effect {
    ...
    wrapText(text) {
      ...
      gradient.addColorStop(0.3, "#f4ed66");
      ...
      this.textY =
        this.canvasHeight / 2 - textHeight / 2 + this.textVerticleOffset;
